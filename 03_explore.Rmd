...
As we showed you in the previous session, when we're looking at large or unfamiliar datasets it's useful to do some quick checks to get an idea of the kind of data we're working with. For example, we can look at the first and last rows of our data:
